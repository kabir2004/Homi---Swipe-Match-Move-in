...
export default function TestImprovedPage() {
  ...
  return (
    <div className="min-h-screen p-8">
      <h1 className="text-2xl font-bold mb-4">HomiBuoy Improved Test</h1>
      <p className="mb-8">This page tests the improved HomiBuoy component with your specific API key.</p>
      ...
      <div className="mt-12">
        <h2 className="text-xl font-bold mb-4">HomiBuoy Improved Component</h2>
        <p className="mb-4">Click the chat bubble in the bottom right to test the improved HomiBuoy component.</p>
        <HomiBuoyImproved />
      </div>
    </div>
  )
